...
struct Media: Codable, Identifiable, Equatable, Hashable {
    ...
    var thumbnailUrl: URL? {
        guard let posterPath = posterPath ?? profilePath  else { return nil }
...
extension Media {
    static let previewGodfather = Media(posterPath: "/vDGr1YdrlfbU9wxTOdpf3zChmv9.jpg",backdropPath: nil, profilePath: nil, id: 238, mediaType: .movie, title: "The Godfather", name: nil, overview: "lorem ipsum", releaseDate: "2020-10-20", firstAirDate: nil, watchedAt: Date(timeIntervalSinceNow: 0), details: .movie(MovieDetails(id: 1, runtime: 125, imdbId: nil)))
    
    static let previewGodfatherLong =  Media(posterPath: "/3bhkrj58Vtu7enYsRolD1fZdja1.jpg", backdropPath: nil, profilePath: nil, id: 238, mediaType: .movie, title: "The Godfather", name: nil, overview: "My money's in that office, right? If she start giving me some bullshit about it ain't there, and we got to go someplace else and get it, I'm gonna shoot you in the head then and there. Then I'm gonna shoot that bitch in the kneecaps, find out where my goddamn money is. She gonna tell me too. Hey, look at me when I'm talking to you, motherfucker. You listen: we go in there, and Winston or anybody else is in there, you the first motherfucker to get shot. You understand?", releaseDate: "1895-10-20", firstAirDate: nil, watchedAt: Date(timeIntervalSinceNow: 0))
    
    static let previewWonderYears = Media(posterPath: "/tGmCxGkVMOqig2TrbXAsE9dOVvX.jpg", backdropPath: nil, profilePath: nil, id: 238, mediaType: .tv, title: nil, name: "Wonder years", overview: "lorem ipsum", releaseDate: nil, firstAirDate: "2015-05-20")
}
