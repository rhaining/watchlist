...
extension Media {
    static let previewGodfather = Media(posterPath: "/vDGr1YdrlfbU9wxTOdpf3zChmv9.jpg",backdropPath: nil, id: 238, mediaType: .movie, title: "The Godfather", name: nil, overview: "lorem ipsum", releaseDate: "2020-10-20", firstAirDate: nil, watchedAt: Date(timeIntervalSinceNow: 0))
